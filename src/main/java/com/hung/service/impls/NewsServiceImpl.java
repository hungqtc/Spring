...
import com.hung.converter.NewsConverter;
...
import com.hung.repository.NewsRepository;
...
public class NewsServiceImpl implements NewsService {
	...
	public List<NewsDTO> getAll() {
		...
		return newsConverter.toDTO(listEntity);
	}
	...
	public NewsDTO save(NewsDTO newsDTO) {
		...
		CategoryEntity categoryEntity = categoryRepository.findOneByName(newsDTO.getCatName());
