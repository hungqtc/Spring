...
import com.hung.converter.AddressConverter;
...
public class AddressServiceImpl implements AddressService {
	 ...
	 @Override
		public List<AddressDTO> getAll() {
			List<AddressEntity> listEntity = addressRepository.findAll();
			return addressConverter.toDTO(listEntity);
		}
		...
		public AddressDTO save(AddressDTO addressDTO) {
			...
			if (addressDTO.getId() != null) {
				AddressEntity oldAddressEntity = addressRepository.findOne(addressDTO.getId());
				addressEntity = addressConverter.toEntity(addressDTO, oldAddressEntity);
			} else {
				addressEntity = addressConverter.toEntity(addressDTO);
			}
			UserEntity userEntity = userRepository.findOneByName(addressDTO.getUser());
